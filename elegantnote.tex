...
\begin{proof}
    假设负元不唯一,设$β_1,β_2$都是$α$的负元,且有$β_1 \neq β_2 $.则有
    \begin{equation*}
        \begin{aligned}
...
\\3.由$U\neq \varnothing,\exists β ∈ U$,使得,$0β=0 ∈ U$,从而$0 ∈ U$,零元存在.\\
...
对于方程组：\\
$x_1α_1+x_2α_2+...+x_nα_n=\beta$ $
\\\Longleftrightarrow$
$K$中有一组$c_1,c_2,...,c_n$,使得$c_1α_1+c_2α_2+...+c_nα_n=\beta$
$\\\Longleftrightarrow$
$\beta$可以由$α_1,α_2,...,α_n$线性表出。
$\\\Longleftrightarrow$
$\beta \in <α_1,α_2,...,α_n>$（生成的子空间）。
