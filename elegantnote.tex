...
\begin{proposition}
    设$α_1,α_2,...,α_s$线性无关,若$α_1,α_2,...,α_s,\beta$线性相关，那么$\beta$可以由$α_1,α_2,...,α_s$线性表出.
\end{proposition}
\begin{proof}
    由$α_1,α_2,...,α_s,\beta$线性相关，则存在不全为零的一组数$k_1,k_2,...,.k_s,l$,使得:
    \begin{equation*}
        k_1 α_1+k_2 α_2+...+k_s α_s+l \beta =0 
    \end{equation*}
    若$l=0$,则有
    \begin{equation*}
        k_1 α_1+k_2 α_2+...+k_s α_s=0 
    \end{equation*}
    由$α_1,α_2,...,α_s$线性无关，则有$k_1,k_2,...,.k_s$全为零，再加上$l$,有$k_1,k_2,...,.k_s,l$全为零，与$α_1,α_2,...,α_s,\beta$线性相关矛盾，假设不成立。所以$l\neq 0$.
    则有
    \begin{equation*}
         \beta =-\frac{k_1}{l} α_1-\frac{k_2}{l} α_2-...-\frac{k_s}{l} α_s 
    \end{equation*}
\end{proof}
...
\begin{definition}
    若向量组$α_1,α_2,...,α_s$中的每一个向量都可以由$\beta_1,\beta_2,...,\beta_r$线性表出，则称$α_1,α_2,...,α_s$可以由$\beta_1,\beta_2,...,\beta_r$线性表出.
    若$α_1,α_2,...,α_s$和$\beta_1,\beta_2,...,\beta_r$可以相互线性表出，则称这两个向量组是等价的，记作:
    \begin{equation*}
        \{α_1,α_2,...,α_s\} \cong \{\beta_1,\beta_2,...,\beta_r\}
    \end{equation*}
\end{definition}
...
\begin{equation*}
    α_j=0α_1+...+α_j+...+0\alpha_s,j=1,2,...,m
\end{equation*}
